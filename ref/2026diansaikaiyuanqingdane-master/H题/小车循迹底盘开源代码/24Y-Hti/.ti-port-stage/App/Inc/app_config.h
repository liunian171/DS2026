...
/* Temporary RAM trace for straight-line and arc-exit diagnosis. */
#define APP_H_DEBUG_TRACE_ENABLED            1U
#define APP_H_DEBUG_TRACE_INTERVAL_MS       100U
#define APP_H_DEBUG_TRACE_CAPACITY          256U
...
#define APP_H_TASK2_LINE_KP                    24
#define APP_H_TASK2_MAX_YAW_MDEG_S             30000
...
#define APP_H_TASK2_LINE_MID_SPEED_MM_S         280
#define APP_H_TASK2_LINE_EDGE_SPEED_MM_S        220
#define APP_H_TASK2_CENTERING_START_MDEG         125000
#define APP_H_TASK2_CENTERING_MAX_MDEG           190000
#define APP_H_TASK2_CENTERING_STABLE_FRAMES      3U
#define APP_H_TASK2_CENTERING_SPEED_MM_S          220
#define APP_H_TASK2_CENTERING_GAIN_NUMERATOR      1
#define APP_H_TASK2_CENTERING_GAIN_DENOMINATOR    1
...
#define APP_H_DIAGONAL_ARM_BLANK_STABLE_FRAMES       3U
#define APP_H_DIAGONAL_ENDPOINT_MIN_TRAVEL_MM       300
#define APP_H_DIAGONAL_PREVIEW_START_REMAINING_MM   260
#define APP_H_DIAGONAL_PREVIEW_FULL_REMAINING_MM     50
#define APP_H_DIAGONAL_PREVIEW_HEADING_MDEG       12000
/* 循迹模块位于驱动轮接地点前方，检测端点后轮轴还需继续前进该距离。 */
#define APP_H_LINE_SENSOR_FORWARD_OFFSET_MM          50
#define APP_H_CROSS_EXIT_ADVANCE_SPEED_MM_S          120
#define APP_H_TASK2_PRE_ENTRY_DISTANCE_MM           120
#define APP_H_TASK3_PRE_ENTRY_DISTANCE_MM           120
#define APP_H_PRE_ENTRY_SPEED_MM_S                  220
#define APP_H_TASK3_DIAGONAL_TAIL_DISTANCE_MM       120
#define APP_H_TASK3_DIAGONAL_TAIL_SPEED_MM_S        220
/* 高速预瞄：在预计弯口前平滑加入圆弧前馈，黑线只修正模型误差。 */
#define APP_H_TASK2_PREVIEW_START_REMAINING_MM       50
#define APP_H_TASK2_PREVIEW_FULL_REMAINING_MM         0
#define APP_H_PREVIEW_ARC_YAW_MDEG_S                  0
#define APP_H_TASK2_CD_SETTLE_SPEED_MM_S             150
#define APP_H_TASK2_CD_SETTLE_TOLERANCE_MDEG        2000
#define APP_H_TASK2_CD_SETTLE_TIMEOUT_MS             300U
#define APP_H_ENTRY_CAPTURE_PHASE_MS              2200U
#define APP_H_ENTRY_CAPTURE_LOST_GRACE_MS          1800U
#define APP_H_ENDPOINT_ALIGN_FINE_YAW_MDEG_S      20000
#define APP_H_ENDPOINT_ALIGN_CENTER_STABLE_FRAMES     3U
#define APP_H_ARC_ENTRY_SPEED_MM_S                  220
#define APP_H_ARC_EXIT_SPEED_MM_S                   220
#define APP_H_ARC_ENTRY_CENTER_STABLE_FRAMES          8U
#define APP_H_ARC_NOMINAL_RADIUS_MM                   400
#define APP_H_MDEG_PER_RAD                          57296
#define APP_H_ARC_TAIL_HEADING_KP                        3
#define APP_H_ARC_TAIL_MAX_YAW_MDEG_S                43000
#define APP_H_TASK2_ARC_SPEED_MM_S              280
#define APP_H_TASK2_ARC_BASE_YAW_MDEG_S         (-52000)
#define APP_H_TASK2_ARC_MAX_YAW_MDEG_S         150000
#define APP_H_TASK2_ARC_GYRO_TAKEOVER_MDEG      170000
...
#define APP_H_TASK3_AC_ENTRY_OFFSET_MDEG           0
...
#define APP_H_TASK3_LINE_KP                    24
#define APP_H_TASK3_MAX_LINE_YAW_MDEG_S        30000
...
#define APP_H_TASK3_LINE_MID_SPEED_MM_S        280
#define APP_H_TASK3_LINE_EDGE_SPEED_MM_S       220
...
#define APP_H_TASK3_ARC_SPEED_MM_S             280
#define APP_H_TASK3_ARC_BASE_YAW_MDEG_S        52000
...
#define APP_H_CROSS_ARC_WHITE_EXIT_ARM_MDEG    160000
#define APP_H_CROSS_ARC_WHITE_EXIT_STABLE_MS       15U
...
/* Direction diagnostic: left reverse, pause, then right reverse. */
#define APP_DIRECTION_DIAGNOSTIC_ENABLED  0U
#define APP_DIRECTION_DIAGNOSTIC_DELAY_MS 10000U
#define APP_DIRECTION_DIAGNOSTIC_RUN_MS   2000U
#define APP_DIRECTION_DIAGNOSTIC_PAUSE_MS 1500U
#define APP_DIRECTION_DIAGNOSTIC_DUTY     400
...
#define APP_DISTANCE_TEST_TARGET_MM         500
...
#define APP_HEADING_HOLD_KP_X1000               4000
#define APP_HEADING_HOLD_MAX_YAW_MDEG_S         40000
...
/* First motorized D2..D7 line-following test. */
#define APP_LINE_FOLLOW_TEST_ENABLED             0U
#define APP_LINE_FOLLOW_TEST_DELAY_MS            10000U
#define APP_LINE_FOLLOW_TEST_RUN_MS             60000U
#define APP_LINE_FOLLOW_TEST_POST_STOP_MS        1000U
#define APP_LINE_FOLLOW_LINEAR_MM_S              220
#define APP_LINE_FOLLOW_KP                        16
#define APP_LINE_FOLLOW_MAX_YAW_MDEG_S           70000
#define APP_SQUARE_LINE_CENTER_SPEED_MM_S          220
#define APP_SQUARE_LINE_MID_SPEED_MM_S             160
#define APP_SQUARE_LINE_EDGE_SPEED_MM_S            100
#define APP_SQUARE_LINE_CENTER_KP                    16
#define APP_SQUARE_LINE_MID_KP                       28
#define APP_SQUARE_LINE_EDGE_KP                      34
#define APP_SQUARE_LINE_KD_PER_FRAME                 14
#define APP_SQUARE_LINE_MID_ERROR_X1000            1000
#define APP_SQUARE_LINE_EDGE_ERROR_X1000           2000
#define APP_SQUARE_LINE_CORNER_CONFIRM_FRAMES         2U
#define APP_SQUARE_LINE_CENTER_CONFIRM_FRAMES         3U
#define APP_SQUARE_LINE_CORNER_SPEED_MM_S             40
#define APP_SQUARE_LINE_CORNER_YAW_MDEG_S           90000
#define APP_SQUARE_LINE_RECOVERY_SPEED_MM_S           40
#define APP_SQUARE_LINE_RECOVERY_YAW_MDEG_S         70000
#define APP_SQUARE_LINE_RECOVERY_TIMEOUT_MS          1500U
#define APP_SQUARE_LINE_SLEW_CPS_PER_SECOND         30000
...
#define APP_H_REVERSE_FAULT_MIN_CPS           300
#define APP_H_REVERSE_FAULT_CONFIRM_SAMPLES     3U
...
/* Fixed-point gains: Kp=0.050, Ki=0.300/s. */
#define APP_SPEED_PI_KP_X1000              50
#define APP_SPEED_PI_KI_X1000_PER_SECOND   300
#define APP_SPEED_PI_FEEDFORWARD_GAIN_X1000 113
#define APP_SPEED_PI_OUTPUT_MIN_PERMILLE   0
#define APP_SPEED_PI_OUTPUT_MAX_PERMILLE   700
#define APP_SPEED_PI_INTEGRAL_LIMIT        250
